...

{
	...
	int evaluateBoard2(int[] board, boolean south)
	{
		...
		if(south)
		{
			return ((100 * southSum + 10 * board[6]) - (100 * northSum + 10 * board[13])
					   + 1000 * board[3] + 1000 * board[4] + 1000 * board[5]);
			
		}
		else
		{
			return ((100 * northSum + 10 * board[13]) - (10 * southSum + 10 * board[6])
					   + 1000 * board[10] + 1000 * board[11] + 1000 * board[12]);
		}	
	...
	boolean southturn = false;
	int southsidesum = 0;
	int northsidesum = 0;
	int southCaptures = 0;
	int northCaptures = 0;
	int leaves = 0; 
	int[] NCoefficients = new int[7];
	int[] SCoefficients= new int[7];
	int[] boardstate;
